    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_type', models.ForeignKey(limit_choices_to={'app_label__in': ['messages', 'staticfiles', 'rest_framework', 'drf_spectacular', 'core', 'user', 'hr', 'company', 'partners']}, on_delete=django.db.models.deletion.CASCADE, to='contenttypes.contenttype')),
            ],
            options={
                'ordering': ['name'],
                'permissions': [],
