...
class BimaErpPartner(AbstractModel):
    ...
    company_siret = models.CharField(blank=True, null=True, verbose_name=_('Company Siret'))
    company_date_registration = models.DateTimeField(blank=True, null=True, verbose_name=_('Company Date Registration'))
    rcs_number = models.CharField(blank=True, null=True, verbose_name=_('RCS Number'))
    company_date_struck_off = models.DateTimeField(blank=True, null=True, verbose_name=_('Company Date Struck Off'))
    company_ape_text = models.CharField(blank=True, null=True, verbose_name=_('Company APE Text'))
    company_ape_code = models.CharField(blank=True, null=True, verbose_name=_('Company APE Code'))
