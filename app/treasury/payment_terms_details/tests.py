...
class TestBimaTreasuryPaymentTermsDetailsAPI:
    ...
    def model(self, model_data):
        return BimaTreasuryPaymentTermsDetails.objects.create(**model_data)
    ...
    def test_create_model(self, api_client, model_data):
        ...
        assert BimaTreasuryPaymentTermsDetails.objects.filter(**model_data).exists()
    ...
    def test_retrieve_model(self, api_client, model):
        ...
        assert response.data == BimaTreasuryPaymentTermsDetailsSerializer(model).data
    ...
    def test_delete_model(self, api_client, model):
        ...
        assert not BimaTreasuryPaymentTermsDetails.objects.filter(id=model.id).exists()
