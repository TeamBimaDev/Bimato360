...
urlpatterns = [
    ...
    path('user_activate_and_change_password/<str:public_id>/<str:uidb64>/<str:token>/',
         CreateUserPasswordForFirstTime.as_view(), name='user_activate_and_change_password'),
