...
class BimaHrCondidatPoste(AbstractModel):
    expected_salary = models.FloatField(blank=True, default=None)
    proposed_salary = models.FloatField(blank=True, default=None)
    accepted_salary = models.FloatField(blank=True, default=None)
