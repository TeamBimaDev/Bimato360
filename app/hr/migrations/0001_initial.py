# Generated by Django 4.2.1 on 2023-05-16 08:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True)),
                ('name', models.CharField(max_length=255, unique=True)),
                ('applicant', models.ManyToManyField(related_name='skill_condidat', to='hr.bimahrapplicant')),
                ('skillcategorys', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hr.skillcategory')),
            ],
            options={
                'permissions': [],
            },
