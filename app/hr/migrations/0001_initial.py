    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True)),
                ('name', models.CharField(max_length=255, unique=True)),
                ('applicant', models.ManyToManyField(blank=True, null=True, related_name='BimaHrApplicantSkill', to='hr.bimahrapplicant')),
                ('skill_categories', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='hr.skillcategory')),
            ],
            options={
                'permissions': [],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('poste', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.bimacorepost')),
            ],
            options={
                'ordering': ['raison'],
                'permissions': [],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.bimacorepost')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(through='hr.BimaHrApplicantPost', to='core.bimacorepost'),
        ),
        migrations.AddField(
            model_name='bimahrapplicant',
            name='company_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='company.bimacompany'),
        ),
        migrations.AddField(
            model_name='bimahrapplicant',
            name='id_source_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.bimacoresource'),
        ),
        migrations.AddField(
            model_name='bimahrapplicant',
            name='steps',
