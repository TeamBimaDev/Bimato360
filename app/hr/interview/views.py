        ...
        if cv_content is not None:
            try:
                ...
                generate_questions_prompt = ChatPromptTemplate.from_template(
                    "Create an interview guideline and prepare a total of 8 human resource-focused questions. "
                    "These questions should assess the candidate's soft skills, work habits, team dynamics, and overall fit within the company culture. "
