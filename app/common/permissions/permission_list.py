class PermissionsList:
    ...
    CORE_ADDRESS_CREATE = ('core.address.can_create', 'Can create address', 'CORE_ADDRESS')
    CORE_ADDRESS_UPDATE = ('core.address.can_update', 'Can update address', 'CORE_ADDRESS')
    CORE_ADDRESS_DELETE = ('core.address.can_delete', 'Can delete address', 'CORE_ADDRESS')
    CORE_ADDRESS_READ = ('core.address.can_read', 'Can read address', 'CORE_ADDRESS')

    CORE_CONTACT_CREATE = ('core.contact.can_create', 'Can create contact', 'CORE_CONTACT')
    CORE_CONTACT_UPDATE = ('core.contact.can_update', 'Can update contact', 'CORE_CONTACT')
    CORE_CONTACT_DELETE = ('core.contact.can_delete', 'Can delete contact', 'CORE_CONTACT')
    CORE_CONTACT_READ = ('core.contact.can_read', 'Can read contact', 'CORE_CONTACT')

    CORE_COUNTRY_CREATE = ('core.country.can_create', 'Can create country', 'CORE_COUNTRY')
    CORE_COUNTRY_UPDATE = ('core.country.can_update', 'Can update country', 'CORE_COUNTRY')
    CORE_COUNTRY_DELETE = ('core.country.can_delete', 'Can delete country', 'CORE_COUNTRY')
    CORE_COUNTRY_READ = ('core.country.can_read', 'Can read country', 'CORE_COUNTRY')

    CORE_CURRENCY_CREATE = ('core.currency.can_create', 'Can create currency', 'CORE_CURRENCY')
    CORE_CURRENCY_UPDATE = ('core.currency.can_update', 'Can update currency', 'CORE_CURRENCY')
    ...
    CORE_DEPARTMENT_READ = ('core.department.can_read', 'Can read department', 'CORE_DEPARTMENT')

    CORE_DOCUMENT_CREATE = ('core.document.can_create', 'Can create document', 'CORE_DOCUMENT')
    CORE_DOCUMENT_UPDATE = ('core.document.can_update', 'Can update document', 'CORE_DOCUMENT')
    CORE_DOCUMENT_DELETE = ('core.document.can_delete', 'Can delete document', 'CORE_DOCUMENT')
    CORE_DOCUMENT_READ = ('core.document.can_read', 'Can read document', 'CORE_DOCUMENT')

    CORE_ENTITY_TAG_CREATE = ('core.entity_tag.can_create', 'Can create entity tag', 'CORE_ENTITY_TAG')
    CORE_ENTITY_TAG_UPDATE = ('core.entity_tag.can_update', 'Can update entity tag', 'CORE_ENTITY_TAG')
    CORE_ENTITY_TAG_DELETE = ('core.entity_tag.can_delete', 'Can delete entity tag', 'CORE_ENTITY_TAG')
    CORE_ENTITY_TAG_READ = ('core.entity_tag.can_read', 'Can read entity tag', 'CORE_ENTITY_TAG')

    CORE_POST_CREATE = ('core.post.can_create', 'Can create post', 'CORE_POST')
    CORE_POST_UPDATE = ('core.post.can_update', 'Can update post', 'CORE_POST')
    CORE_POST_DELETE = ('core.post.can_delete', 'Can delete post', 'CORE_POST')
    CORE_POST_READ = ('core.post.can_read', 'Can read post', 'CORE_POST')
    ...
    ERP_SALE_DOCUMENT_CREATE = ('erp.sale_document.can_create', 'Can create sale document', 'ERP_SALE_DOCUMENT')
    ERP_SALE_DOCUMENT_UPDATE = ('erp.sale_document.can_update', 'Can update sale document', 'ERP_SALE_DOCUMENT')
    ERP_SALE_DOCUMENT_DELETE = ('erp.sale_document.can_delete', 'Can delete sale document', 'ERP_SALE_DOCUMENT')
    ERP_SALE_DOCUMENT_READ = ('erp.sale_document.can_read', 'Can read sale document', 'ERP_SALE_DOCUMENT')

    ERP_SALE_DOCUMENT_ADD_PRODUCT = ('erp.sale_document.can_add_product',
                                     'Can add product to sale document', 'ERP_SALE_DOCUMENT'
                                     )
    ERP_SALE_DOCUMENT_UPDATE_PRODUCT = ('erp.sale_document.can_update_product',
                                        'Can update product in a sale document', 'ERP_SALE_DOCUMENT')
    ERP_SALE_DOCUMENT_DELETE_PRODUCT = ('erp.sale_document.can_delete_product',
                                        'Can delete product from sale document', 'ERP_SALE_DOCUMENT')
    ERP_SALE_DOCUMENT_CHANGE_STATUS = ('erp.sale_document.can_change_status',
                                       'Can change status of sale document', 'ERP_SALE_DOCUMENT')
    ERP_SALE_DOCUMENT_ROLLBACK_STATUS = ('erp.sale_document.can_rollback_status',
                                         'Can rollback status of sale document', 'ERP_SALE_DOCUMENT')
    ERP_SALE_DOCUMENT_GENERATE_DOCUMENT = ('erp.sale_document.can_generate_document',
                                           'Can generate document from sale document', 'ERP_SALE_DOCUMENT')
    ...
    COMPANY_COMPANY_DELETE = ('company.company.can_delete', 'Can delete company', 'COMPANY_COMPANY')
